  ...
  plugins: [
    ...
    purgecss({
      ...
      safelist: [
        ...
        'featured-quotes',
        'featured-quotes__header',
        'featured-quotes__kicker',
        'featured-quotes__title',
        'featured-quotes__grid',
        'featured-quotes__card',
        'featured-quotes__quote',
        'featured-quotes__person',
        'featured-quotes__photo',
        'featured-quotes__card--text',
        'featured-quotes__body',
        'featured-quotes__meta',
        'featured-quotes__name',
        'featured-quotes__role',
        'featured-quotes__cta',
        'featured-quotes__more',
        'featured-quotes__more-show',
        'featured-quotes__more-hide',
        'footer__inner',
        'footer__logo',
        'footer__cta',
        'footer__legal',
